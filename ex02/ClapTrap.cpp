...
ClapTrap::ClapTrap(void):
	...
	energyPoints(0),
	attackDamage(0) {
		std::cout << "[INFO]: (Default Constructor (" << getName() << ") (ClapTrap))\n";
	}
...
ClapTrap::ClapTrap(const std::string &param):
	...
	energyPoints(0),
	attackDamage(0) {
		std::cout << "[INFO]: (Parameterized Constructor (" << getName() << ") (ClapTrap))\n";
		}
...
ClapTrap::ClapTrap(const ClapTrap &other) {
	...
	attackDamage = other.getAttackDamage();
		std::cout << "[INFO]: (Copy Constructor (" << getName() << ") (ClapTrap))\n";
}
...
ClapTrap	&ClapTrap::operator=(const ClapTrap &other) {
	...
	energyPoints = other.getEnergyPoints();
	attackDamage = other.getAttackDamage();
		std::cout << "[INFO]: (Assignment operator Constructor (" << getName() << ") (ClapTrap))\n";
	return (*this);
}

ClapTrap::~ClapTrap() {
	std::cout << "[INFO]: (Destructor called " << getName() << ") (ClapTrap))\n";
}
